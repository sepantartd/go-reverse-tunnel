...
### داشبورد و متریک‌ها
- `dashboard_addr`: تعیین آدرس و پورت اجرای داشبورد وب و ارائه مسیر `/metrics` برای جمع‌آوری داده‌ها توسط Prometheus (مانند `:8080`).
...
برای اطلاعات بیشتر فایل LICENCE را مشاهده کنید
